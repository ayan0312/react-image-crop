...
class ReactCrop extends PureComponent {
  ...
  componentDidMount() {
    if (this.componentRef.addEventListener) {
      ...
      this.componentRef.addEventListener('mousemove', this.onDocMouseTouchMove, options);
      this.componentRef.addEventListener('touchmove', this.onDocMouseTouchMove, options);

      this.componentRef.addEventListener('mouseup', this.onDocMouseTouchEnd, options);
      this.componentRef.addEventListener('touchend', this.onDocMouseTouchEnd, options);
      this.componentRef.addEventListener('touchcancel', this.onDocMouseTouchEnd, options);
  ...
  componentWillUnmount() {
    if (this.componentRef.removeEventListener) {
      this.componentRef.removeEventListener('mousemove', this.onDocMouseTouchMove);
      this.componentRef.removeEventListener('touchmove', this.onDocMouseTouchMove);

      this.componentRef.removeEventListener('mouseup', this.onDocMouseTouchEnd);
      this.componentRef.removeEventListener('touchend', this.onDocMouseTouchEnd);
      this.componentRef.removeEventListener('touchcancel', this.onDocMouseTouchEnd);
